...
void display()
{
	...
	for(int t=0; t<9; t++) for(int u=0; u<7; u++) {
...
{
	uint8_t *worldmap = mymmap(filename);
...
{
	//printf("%f\n", median3d(1.0, 2.0, 3.0));
	//printf("%f\n", median3d(2.0, 1.0, 3.0));
	//printf("%f\n", median3d(3.0, 1.0, 2.0));
	//printf("%f\n", median3d(1.0, 3.0, 2.0));
	//printf("%f\n", median3d(2.0, 3.0, 1.0));
	//printf("%f\n", median3d(3.0, 2.0, 1.0));
	glutInit(&argc, argv);
	if (argc < 3)
